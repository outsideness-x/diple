...
public struct AppSettings: Codable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        // reader with `periwinkle` (Ink) on disk may have picked it, and nothing here can tell
        // them apart from one who merely inherited it.
        self.accent = try container.decodeIfPresent(DipleAccent.self, forKey: .accent) ?? .vellum
